...
bot.on("message", async message => {
    ...
    if (command === "gen") {
        if(message.channel.id !== "771057379440590918") return message.channel.send("This command can be runned only in the generate channel")
            ...
            let account = JSON.parse(data)
                ...
                const embed = {
                    ...
                    footer: {
                        ...
                        text: "Buy discord bots from Goziax#6990"
                    },
                    thumbnail: {
                        url:
